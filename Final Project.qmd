...
**Would it be unreasonable to say:** The highest salaries, on average, appear to occur when an individual has approximately 25 years of experience. After 25 years, we see a downward sloping relationship between one additional year of experience and salary. This could be explained by people making high salaries exiting the job market when they have enough savings and retiring. This would drive down the mean salary we see individuals with years of experience making.
...
Looking at Figure 2, which displays the relationship between our numerical outcome variable Salary and our categorical explanatory variable Race, the Salary amounts look to be the greatest for people from Asian or White heritage and the smallest for people from Hispanic or African American heritage, though the difference does not seem to be extreme. There do not seem to be significant outliers.
...
(the complex model is no better than the simple model)}
$$
